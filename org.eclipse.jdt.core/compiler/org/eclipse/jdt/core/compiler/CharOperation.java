...
public final class CharOperation {
	 ...
	 *
	 * @param target
	 *            the array that is concatenated with the suffix array.
	 * @param suffix
	 *            the array that will be concatenated to the target
	 * @return the new array
	...
	/**
	 * Append the given sub-array to the target array starting at the given index in the target array. The start of the
	 * sub-array is inclusive, the end is exclusive. Answers a new target array if it needs to grow, otherwise answers
	 ...
	 * Examples:
	 * <ol>
	 * <li>pattern = "NPE".toCharArray() patternStart = 0 patternEnd = 3 name = "NullPointerException".toCharArray()
	 * nameStart = 0 nameEnd = 20 result => true</li>
	 * <li>pattern = "NPE".toCharArray() patternStart = 0 patternEnd = 3 name = "NoPermissionException".toCharArray()
	 * nameStart = 0 nameEnd = 21 result => true</li>
	 * <li>pattern = "NuPoEx".toCharArray() patternStart = 0 patternEnd = 6 name = "NullPointerException".toCharArray()
	 * nameStart = 0 nameEnd = 20 result => true</li>
	 * <li>pattern = "NuPoEx".toCharArray() patternStart = 0 patternEnd = 6 name = "NoPermissionException".toCharArray()
	 * nameStart = 0 nameEnd = 21 result => false</li>
	 * <li>pattern = "npe".toCharArray() patternStart = 0 patternEnd = 3 name = "NullPointerException".toCharArray()
	 * nameStart = 0 nameEnd = 20 result => false</li>
	 * <li>pattern = "IPL3".toCharArray() patternStart = 0 patternEnd = 4 name = "IPerspectiveListener3".toCharArray()
	 * nameStart = 0 nameEnd = 21 result => true</li>
	 * <li>pattern = "HM".toCharArray() patternStart = 0 patternEnd = 2 name = "HashMapEntry".toCharArray() nameStart =
	 * 0 nameEnd = 12 result => true</li>
	 * </ol>
	 *
	 * @param pattern
	 *            the given pattern
	 ...
	 * array is null, then it answers the concatenation of first and second inserting the sep1 character between them.
	 * <br>
	 * <br>
	 * For example:
	 * <ol>
	...
	/**
	 * Answers the concatenation of the given array parts using the given separator between each part and prepending the
	 * given name at the beginning. <br>
	 * <br>
	 * For example:<br>
	 * <ol>
	 * <li>
	 ...
	 * @param separator
	 *            the given separator
	 * @return the concatenation of the given array parts using the given separator between each part and prepending the
	 *         given name at the beginning
	 */
	 ...
	 * from position secondStart (inclusive) to secondEnd(exclusive), otherwise false. The equality is case sensitive.
	 * <br>
	 * <br>
	 * For example:
	 * <ol>
	 ...
	 * <p>
	 * Answers true if the first array is identical character by character to a portion of the second array delimited
	 * from position secondStart (inclusive) to secondEnd(exclusive), otherwise false. The equality could be either case
	 * sensitive or case insensitive according to the value of the <code>isCaseSensitive</code> parameter.
	 * </p>
	 * <p>
	 * For example:
	 * </p>
	 ...
	 *
	 * <p>
	 * When not case sensitive, the pattern is assumed to already be lowercased, the name will be lowercased character
	 ...
	 *
	 * Path char[] pattern matching, accepting wild-cards '**', '*' and '?' (using Ant directory tasks conventions, also
	 * see "http://jakarta.apache.org/ant/manual/dirtasks.html#defaultexcludes"). Path pattern matching is enhancing
	 * regular pattern matching in supporting extra rule where '**' represent any folder combination. Special rule: -
	 * foo\ is equivalent to foo\** When not case sensitive, the pattern is assumed to already be lowercased, the name
	...
	/**
	 * Return the int value represented by the designated subpart of array. The calculation of the result for
	 * single-digit positive integers is optimized in time.
	 * 
	 * @param array
	...
	/**
	 * Answers a new array removing a given character. Answers the given array if there is no occurrence of the
	 * character to remove. <br>
	 * <br>
	 * For example:
	 * <ol>
	 * <li>
	...
	/**
	 * Replace all occurrences of characters to be replaced with the replacement character in the given array from the
	 * start position (inclusive) to the end position (exclusive). <br>
	 * <br>
	 * For example:
	 * <ol>
	 * <li>
	...
	/**
	 * Replace all occurrence of the character to be replaced with the replacement character in a copy of the given
